...
return (
    <div className="bg-[#F0F0F0] px-3 py-4 flex items-center gap-2 border-t border-gray-200">
      ...
      <button className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-200"  onClick={() => fileInputRef.current.click()}>
